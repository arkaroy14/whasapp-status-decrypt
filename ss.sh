...
# BELOW FORMATTING TEXT TO ONLY TAKE 248 CHARACTERS FROM FILE NAME BECAUSE LINUX ONLY SUPPORT 255 CHARACTERS IN FILENAME INCLUDING EXTENSION SO WE ONLY TAKING 248 FROM STATUS TEXT IN OUR FILENAME NOW FILENAME HAVING COUNT WHICH NEEDS 2,THEN ONE FIRST BRACKET NEEDS 1,PHONE NO NEEDS 10, TWO FIRST BRACKET NEEDS 2,TOTAL 15 NOW 248-15(+3)=230
stxt=$(echo $text | head -c 230)
